...
function alertV2() {
    ...
    var updateDescriptionPath = '/description/'
    ...
    return {
        ...
        * */
        ...
        updateDescription: function (identifier, data, config, cb) {
            var path = api.getPath(baseURL, identifier, updateDescriptionPath, data);
